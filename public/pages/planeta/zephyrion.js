import { get_recipes_id } from "../fetch/recipes.js";

const teste = async () => {
  // root:
  let DB = await get_recipes_id(1);
  ...
  methodText.textContent = `${DB.instructions}`;
  ...
  const planeta1 = document.createElement("img");
  planeta1.src = "planeta1.png";
